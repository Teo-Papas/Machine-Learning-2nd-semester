...
print('Biasses:',b_list)
print('Weights:',m_list)
# Section 3: Show convergence of weights
#BP(x=b_list, y=cost_list,t='Convergence of b Values vs. Cost',x_t='b Values', y_t='Cost',xp=b_list, yp=cost_list)
 
#BP(m_list, cost_list,t='Convergence of m Values vs. Cost',x_t='m Values', y_t='Cost',xp=m_list, yp=cost_list)
...
#BP(x=Xtp, y=Yt,t='Y Predictions for X from Trained Model',xp=Xp, yp=Y)